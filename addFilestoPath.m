...
path2add{end+1} = fullfile(rootDir,'Exercise/Ex1');
path2add{end+1} = fullfile(rootDir,'Exercise/Ex2');
path2add{end+1} = fullfile(rootDir,'Exercise/Ex3');
path2add{end+1} = fullfile(rootDir,'Exercise/Ex4');
path2add{end+1} = fullfile(rootDir,'Exercise/Ex5');
